      ...
      <div class="row">
          <div class="col-8 main" >
             <div class="main-top">
                 ...
                 <div class="title">
                  <nuxt-link to="/u/123" class="name">不思量自难忘</nuxt-link>
                 </div>
                 <div class="info">
                  <ul>
                      <li>
                     ...
                     <ul class="note-list" v-if="dynamic">
                         ...
                         <li>
                             <div class="content">
                                 <div class="author">
                                     ...
                                     <div class="info">
                                         <nuxt-link to="/u/123" class="nickname">不思量自难忘</nuxt-link>
                                         <em> • </em>
                                         <span>赞了评论 • 02.05 12:14</span>
                                     </div>
                                 </div>
                                 <p class="comment">
                                     能力是我一直认为很重要的，不过在部门久了，也觉得不过如此，性格才是最重要的那个。
                                 </p>
                                 <blockquote>
                                     <div class="origin-author">
                                         <nuxt-link to="/u/123">云卷云舒</nuxt-link>
                                         <span>评论自
                                         <a href="javascript:void(0)">看庭前花开花落</a>
                                         </span>
                                     </div>
                                 </blockquote>
                             </div>
                         ...
                         <li>
                                 ...
                                 <div class="author">
                                     ...
                                     <div class="info">
                                         <nuxt-link to="/u/123" class="nickname">不思量自难忘</nuxt-link>
                                         <em> • </em>
                                         <span>发表了评论 • 02.05 12:14</span>
                                     </div>
                                 </div>
                                 <p class="comment">
                                     <img class="emoji" src="//static.jianshu.io/assets/emojis/clap.png" alt="" height="20px" width="20px">
                                 </p>
                                 <blockquote>
                                   <nuxt-link to="/p/123" class="title">简书介绍</nuxt-link>
                                    <p class="abstract">开始你的简书！</p>
                                    <div class="meta">
                                        <div class="origin-author">
                                            <nuxt-link to="/u/123">不思量自难忘</nuxt-link>
                                        </div>
                                        <nuxt-link to="/p/123">
                                        <i class="fa fa-eye"></i>
                                        6
                         ...
                         <li>
                             <div class="content">
                                ...
                                <blockquote style="padding-top:0;border-left:0;padding-left:0">
                                   <nuxt-link to="/p/123" class="liketitle">决定你前途的，不是学历，而是能力</nuxt-link>
                                    <p class="abstract" style="color:#333">
                                        昨天晚上，正在我准备睡觉的时候，小武给我打来电话说：“我这辈子算是毁在学历上了。” 聊了许久，我才知道，小武去应聘培训机构的老师被拒绝了。那家培训机构的对学历的要求是98...
                                    </p>
                                    <div class="meta">
                                        <div class="origin-author">
                                            <nuxt-link to="/u/123">清仁</nuxt-link>
                                        </div>
                                        <nuxt-link to="/p/123">
                                        <i class="fa fa-eye"></i>
                                        531
                              ...
                              <div class="content">
                                 ...
                                 <blockquote>
                                     <div class="origin-author">
                                         <nuxt-link to="/u/123">不思量自难忘</nuxt-link>
                                         <span>评论自
                                         <a href="javascript:void(0)">使用简书</a>
                                         </span>
                                     </div>
                                 </blockquote>
                             </div>
                                    ...
                                    <div class="info">
                                       <a href="javascript:void(0)" class="avatar-collection">
                                        ...
                                        <a href="javascript:void(0)" class="is_follow" ref="aFollow"  @click="followBtn" @mouseover="followOver" @mouseout="followOut">
                                            ...
                                            <span ref="followed">已关注</span>
                                        </a>
                                        <a href="javascript:void(0)" class="title">程序员</a>
                                        <p>
                                            <a href="javascript:void(0)" class="creater">简书</a>
                                            编，80488 篇文章，667215 人关注
                                        </p>
                                    </div>
                                    <div class="signature">
                                      欢迎关注公众号简宝玉( 公众号ID : jianshu4321 )后台回复“指南”获取玩转简书绝密珍贵资料汇总；有问题，找宝玉。简宝玉同志会专程为你答疑解惑关于简书的一切。
                                      如果你是程序员，或者有一颗喜欢写程序的心，喜欢分享技术干货、项目经验、程序员日常囧事等等，欢迎投稿《程序员》专题。
                                      专题主编：小彤花园 http://www.jianshu.com/users/4a4eb4feee62/
                                      【程序员】专题拒稿指北：http://www.jianshu.com/p/7c8b33b5f63b
                                       投稿须知：
                                       ...
                                       4.不相关的内容不收录，请确认文章内容和本专题相关
                                       目前简书针对优质作者及爱好者，开设了官方程序员微信群，希望加入请发简信给主编小彤花园索取个人微信，主编会将你加入到【简书-程序员】微信群，分享内容，收获知识。添加微信时备注[简书ID]。
                                    </div>
                                </div>
                             </div>
                         </li>
...
.note-list blockquote .origin-author {
  font-size: 12px;
  color: #969696;
}
